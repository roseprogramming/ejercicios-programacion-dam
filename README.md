...
📖 [`README.md`](src/main/java/com/dam/programacion/fundamentos/README.md)
...
📖 [`README.md`](src/main/java/com/dam/programacion/arrays/README.md)
...
📖 [`README.md`](src/main/java/com/dam/programacion/collections/README.md)
...
📖 [`README.md`](src/main/java/com/dam/programacion/poo/README.md)
...
📁 `src/main/java/com/dam/programacion/proyectos/`
📖 [`README.md`](src/main/java/com/dam/programacion/proyectos/README.md)
...
2. [`src/main/java/com/dam/programacion/README.md`](src/main/java/com/dam/programacion/README.md)
3. [`src/main/java/com/dam/programacion/fundamentos/README.md`](src/main/java/com/dam/programacion/fundamentos/README.md)
...
- [x] **Fundamentos Sólidos** en Java
- [x] **POO Completo**: Herencia, polimorfismo, interfaces, encapsulación
- [x] **Código Profesional**: Documentado, limpio, mantenible
- [x] **Capacidad Analítica**: Resolución de problemas complejos
- [x] **Buenas Prácticas**: JavaDoc, nombres descriptivos, estructura clara
- [x] **Progresión Lógica**: De básico a avanzado, bien organizado
- [x] **Ejemplos Ejecutables**: Todo funciona sin errores
- [x] **Portfolio en GitHub**: Listo para demostrar habilidades

## 🔗 Enlaces Útiles

- [Documentación Oficial Java 21](https://docs.oracle.com/en/java/javase/21/)
...
**Siguiente paso:** Dirígete a [`src/main/java/com/dam/programacion/`](src/main/java/com/dam/programacion/README.md) para empezar 👉
